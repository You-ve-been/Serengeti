...
const q = {
    ...
    2: { "title": "문제 2번", 
    "content": "대체번호 입력을 통해 출결을 해본 적이", 
    "A": "있다",
    "B": "없다"},
    3: { "title": "문제 3번", 
    "content": "마스크를 안 낀 홍만이를 본 적이",
    "A": "있다",
    "B": "없다"},
    4: { "title": "문제 4번", 
    "content": "교’외’셔틀을 탑승해본 적이",
    "A": "있다",
    "B": "없다"},
    5: { "title": "문제 5번", 
    "content": " 불야돈을 먹어본 적이",
    ...
    "B": "없다"},
    6: { "title": "문제 6번", 
    "content": "학교 축제에서 싸이를 본 적이",
    "A": "있다",
    "B": "없다"},
    7: { "title": "문제 7번", 
    "content": "카페 마운틴(a.k.a 산다방)을",
    "A": "안다",
    "B": "모른다"},
    8: { "title": "문제 8번", 
    "content": "새내기 엠티를 가본 적이",
    "A": "있다",
    "B": "없다"},
    9: { "title": "문제 9번", 
    "content": "동아리 가두모집을 당해본 적이",
    "A": "있다",
    "B": "없다"},
    10: { "title": "문제 10번", 
    "content": "축제 주막에서 파는 술을 먹어본 적이",
    "A": "있다",
    "B": "없다"},
    11: { "title": "문제 11번", 
    "content": "프잉, 아잉 수업을 하기 전 건물 1층의 핫도그집에서 핫도그를 먹어본 적이",
    "A": "있다",
    "B": "없다"},
    12: { "title": "문제 12번", 
    "content": "영남대 학생지원센터 가는 길에는 '행복 Start'라는 표지판이",
    "A": "있다",
    "B": "없다"},
    13: { "title": "문제 13번", 
    "content": "브라운그릴이 무엇인지",
    ...
    "B": "모른다"},
    14: { "title": "문제 14번", 
    "content": "3학년부터는 동아리 신규 가입이 불가한 것이",
    "A": "너무하다고 생각한다",
    "B": "너무하지 않다고 생각한다"},
    15: { "title": "문제 15번", 
    "content": "영남대역이 없어 사월역에 내려서 셔틀을 타고 학교에 온 적이",
    "A": "있다",
    "B": "없다"},
    16: { "title": "문제 16번", 
